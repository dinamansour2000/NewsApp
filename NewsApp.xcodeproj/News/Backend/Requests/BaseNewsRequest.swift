...
public class BaseNewsRequest<T: Mappable>: NSObject {
  ...
  /*  private func addDebuggerConfiguration() {
    ...
    func onRequestSuccess(data: T?) {
        preconditionFailure("Override onRequestSuccess func -> BaseNewsRequest")
    }
    
    func onRequestFail() {
        preconditionFailure("Override onRequestFail func -> BaseNewsRequest")
    }
